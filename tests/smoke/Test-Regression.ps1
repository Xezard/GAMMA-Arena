...
local body_health = "zzz_player_injuries BHS_PARTS bhs.health bhs.maxhp bhs.timedhp bhs.save_state bhs.load_state utils.save_var utils.load_var mod_body_health_reset lam2.abort ClearWounds ClearAllBoosters WoundForEach BoosterForEach GetAlcohol ChangeAlcohol remove_all_psy_ppe_effects RemoveTimeEvent set_stage_two 655808 655820 99123 99133 8053 reset_transient_state"
local TacticalProxy = {}
