...
local markers = "WAITING_STABLE HIDING READY UNHIDING LOADING REHIDING CLEANING .scop .scoc .dds .gamma_arena_hidden GA_CHECKPOINT_TIMEOUT GA_CHECKPOINT_UNSAFE_PATH issue_resume consume_resume clear_resume_if_matches pending_or_timeout elapsed_ms engine_fs_port update_path file_rename file_delete"
local mode = "rb"
